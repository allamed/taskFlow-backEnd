...
public interface ITacheService {
    public Tache creerTache(Date deadLine, String titre, Utilisateur responsable, Projet projet);
    //surcharger avec un parametre supplémentaire : breakPoints
    public Tache creerTache(Date deadLine, String titre, Utilisateur responsable, Projet projet, List<Date> breakPoints);
